...
5. Склонировать проект задания - в командном окне с правами пользователя выполнить команду `git clone https://github.com/jigius/tpl-main-page.git` в текущую папку
