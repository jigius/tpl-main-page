...
var initPhotoSwipeFromDOM = function(gallerySelector, reqOpts) {
  ...
  var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
    ...
    if (!!reqOpts) {
      for (var attr in reqOpts) {
        options[attr] = reqOpts[attr];
      }
    }
...
var init = function(galleryElems, options) {
  if (!options) {
    options = {
  ...
  initPhotoSwipeFromDOM(galleryElems, options);
}
